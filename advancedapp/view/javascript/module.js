var myApp = angular.module('myApp', ["Layout",  "WsClient", "HttpClient", "Map", "List", "Chart",  "gridster", "Grid", "Speedometer", "Odometer", "Gauge", "DateTimePicker", "Thermometer", "Button", "ngTagsInput", "Slider", "Accelerometer"]);
...
myApp
    ...
    .config(function($routeProvider, routingJson){
    	  $routeProvider
            .when("/", {
                templateUrl: '/advancedapp/view/html/views/main/main.html'
            });
